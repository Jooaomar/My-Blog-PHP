 ...
 * 
 * [php htmlspecialchars()]: Certos caracteres têm um significado especial em 
 *   HTML e devem ser representados por entidades HTML para preservar seus 
 * significados. Esta função retorna uma string com essas conversões feitas. 
 * se a entrada do usuário (um título de blog ou postagem de blog neste caso) 
 * contiver colchetes angulares, isso pode quebrar o HTML usado no layout da página 
 * e, pior, pode permitir que um usuário injete JavaScript não autorizado  
 *
 * @param string $html
 * @return string
 */
